    ...
    return (
        <div id="sky">
            <div className="blurb static">
                ...
                <p className="blurb-paragraph">I'm from Vancouver, BC based in Seattle, WA. My past work includes everything from brand creation, AAA software development, and World of Warcraft addons.</p>
